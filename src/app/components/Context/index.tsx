  ...
  return (
    ...
    >
      <div className="flex flex-col items-start sticky top-0 w-full">
        ...
        <div className="text-left w-full flex flex-col rounded-b-lg bg-zinc-600 p-3 subpixel-antialiased">
          ...
          <div className="relative w-full">
            <select
              ...
              className="p-2 bg-zinc-700 rounded text-white w-full appearance-none hover:cursor-pointer"
