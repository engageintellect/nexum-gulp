...
const InstructionModal: React.FC<InstructionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="bg-zinc-600 p-5 z-50 rounded-lg shadow-lg relative w-8/12 md:w-5/12">
        <button
          onClick={onClose}
          className="absolute right-2 text-3xl top-0 text-white hover:text-zinc-200"
        >
          &times;
        </button>
