...
const Page: React.FC = () => {
  ...
  return (
    <main className="hi flex flex-col justify-between h-screen bg-zinc-800 p-2 mx-auto max-w-full">
      {/* <Header className="my-5" /> */}

      <div className="text-xl lg:text-2xl  flex items-center justify-between px-4 py-3">
        <button
          type="button"
          className="lg:invisible text-white"
          onClick={(e) => {
            e.currentTarget
              .closest("main")
      ...
      <div className="flex w-full flex-grow overflow-hidden relative">
        <Chat
          ...
          messages={messages}
        />
        <div className="absolute transform translate-x-full transition-transform duration-500 ease-in-out right-0 w-2/3 h-full bg-zinc-700 overflow-y-auto lg:static lg:translate-x-0 lg:w-2/5 lg:mx-2 rounded-lg">
